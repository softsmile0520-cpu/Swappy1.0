...
public class Tutorail7 : MonoBehaviour
{
    ...
    public IEnumerator makeShape()
    {
        if (b == 0)
        {
            ...
            swappyToSwapWith.GetComponent<MeshRenderer>().material.color = Color.red;
            b = 1;
        }
        else
        {
            ...
            swappyToSwapWith.GetComponent<MeshRenderer>().material.color = Color.white;
            ...
            SwappingIdicator.SetActive(true);
