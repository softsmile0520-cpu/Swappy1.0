...
{
    public const string PrivacyAcceptedKey = "PrivacyAccepted";
    ...
    public void Setup(Action onAcceptedCallback, Action onDeclinedCallback = null)
    {
        ...
        if (agreeButton == null)
            Debug.LogWarning("PrivacyPolicyPanel: 'I AGREE' button not found.");
        if (declineButton == null)
            Debug.LogWarning("PrivacyPolicyPanel: 'DECLINE' button not found.");
    }
